...
function this.draw()
	...
	if imgui.tree_node(cached_language.settings) then
		...
		changed, cached_config.settings.render_when_any_menu_is_opened = imgui.checkbox(cached_language.render_when_any_menu_is_opened,
		...
		changed, cached_config.settings.render_when_guarding = imgui.checkbox(cached_language.render_when_guarding,
